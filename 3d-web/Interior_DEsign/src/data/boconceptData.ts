import { FurnitureModel, SwatchOption, LegOption, RoomScene } from '../types';

export const SWATCH_LIBRARY: SwatchOption[] = [
  {
...
export const LEG_FINISHES: LegOption[] = [
  {
    id: 'leg-brass',
    name: 'Brushed Brass',
    finish: 'Brass',
...
export const PRODUCTS_CATALOG: FurnitureModel[] = [
  {
    id: 'bergamo-sofa',
